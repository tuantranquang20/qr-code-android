...
import vn.app.qrcode.data.constant.LAYOUT_WEIGHT_DATA_FIELD_FIRST
...
internal class BarcodeFieldAdapter(private val barcodeFieldList: List<BarcodeField>) :
    ...
    internal class BarcodeFieldViewHolder private constructor(view: View) :
        ...
        private val layoutData: LinearLayoutCompat = view.findViewById(R.id.layout_data)
        ...
        fun bindBarcodeField(barcodeField: BarcodeField, position: Int) {
            ...
            if (position != 0) {
                val param = LinearLayoutCompat.LayoutParams(
                    ...
                    LAYOUT_WEIGHT_DATA_FIELD_FIRST
                )
                layoutData.layoutParams = param
            }
        }
        ...
        companion object {
            ...
            fun create(parent: ViewGroup): BarcodeFieldViewHolder {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.item_barcode_field, parent, false)
