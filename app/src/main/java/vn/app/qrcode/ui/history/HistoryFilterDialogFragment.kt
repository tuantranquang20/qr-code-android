...
import vn.app.qrcode.databinding.FragmentHistoryFilterBinding

class HistoryFilterDialogFragment: BottomSheetDialogFragment() {
    ...
    lateinit var adapter: ItemFilterAdapter
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHistoryFilterBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.historyFilterFragment = this@HistoryFilterDialogFragment
        setListAllQrType()
        setListSelectedType()

        adapter = ItemFilterAdapter(QrCodeTypeListener{type ->
            selectQrCodeType(type)
        }, listSelectType)
        binding.rvListQrCodeType.adapter = adapter

        adapter.submitList(QrCodeTypeData.listQrCodeType)
    }
